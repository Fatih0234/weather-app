...
<p align="left">
Hey there, I have built a weather app that shows you cities' weather condition at the moment. It is designed in a way that you can add the cities you are interested and can track their
weather conditions. There is a delete command as well. The weather informations are coming from openweathermap api. You just need to provide the city name and then your city is saved in the 
database. after then, you will see that city's current weather degree, weather description and weather icon until you delete that city location.
</p>
